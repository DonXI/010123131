...
class Enemy {
    ...
    show () {
        context.drawImage(enemy_sheet.image, this.rand_enemy , 0, this.w, this.h, this.x, this.y, this.w, this.h);
    }
...
function random_enemy(arr){
    return (Math.round(Math.random() * 14) * 50);
}
...
enemy_sheet.image.src = "sum_enemy3.png"
